...
PCRE_TAR_GZ = https://ftp.exim.org/pub/pcre/pcre-8.44.tar.gz
#ZLIB_TAR_GZ = http://zlib.net/zlib-1.2.11.tar.gz
ZLIB_TAR_GZ = https://zlib.net/fossils/zlib-1.2.11.tar.gz


WGET = wget --no-use-server-timestamps --no-check-certificate
